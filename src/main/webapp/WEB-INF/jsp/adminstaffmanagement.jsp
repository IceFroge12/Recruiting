...
<div id="main-container" class="container-fluid">
    ...
    <div id="editEmployee" class="modal fade">
        ...
        <div class="modal-content">
            ...
            <div>
                <table class="table">
                    <tr>
                        <td> First Name</td>
                        <td><input type="text" id="firstNameEdit"></td>
                    </tr>
                    <tr>
                        <td> Second Name</td>
                        <td><input type="text" id="secondNameEdit"></td>
                    </tr>
                    <tr>
                        <td> Last Name</td>
                        <td><input type="text" id="lastNameEdit"></td>
                    </tr>
                    <tr>
                        <td> Email</td>
                        <td><input type="text" id="emailEdit"></td>
                    </tr>
                    <tr>
                        <td> Role</td>
                        <td>
                            <input type="checkbox" id="techEdit" value="option1"> Tech </input>
                            <input type="checkbox" id="softEdit" value="option2"> Soft </input>
                            <input type="checkbox" id="adminEdit" value="option3"> Administrator </input>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="modal-footer">
            <button class="btn btn-default" type="button" id="saveChanges" data-dismiss="modal">Save changes</button>
        </div>
    </div>
